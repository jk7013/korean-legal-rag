...
| Retrieved/bge-m3 (구버전, MCQA 코퍼스) | 3.24 | 3.30 | 2.78 | **3.11** |
| Retrieved/essay-bge-m3 (신버전, 에세이 전용) | 3.39 | 3.34 | 2.92 | **3.22** |
...
- **코드 검토에서 MCQA 코퍼스 혼용 발견** → 에세이 전용 코퍼스(kcl_essay 판례 459개)로 재인덱싱 후 +0.11p 향상 (3.11 → 3.22). 올바른 도메인 데이터를 인덱싱하는 것만으로도 측정 가능한 개선이 가능함을 확인.
